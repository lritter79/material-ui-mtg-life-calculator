...
function CommanderDamageCounter({amountToAddOrSubtract, player, className, currentLife}){
    ...
    return (
        <div>
            <Checkbox className={classes[player.color]} value={player.id} checked={isSelected} />                  
